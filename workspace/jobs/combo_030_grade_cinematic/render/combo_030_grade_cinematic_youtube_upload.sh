...
# 3) Run: bash combo_030_grade_cinematic_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_030_grade_cinematic\render\_seg_combo_030_grade_cinematic_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Grade cinematic","description":"Grade test cinematic.

• Second grade scene.

#Shorts #AI #facts","tags":["logoautomationpng","gradecinematic","wildlogoautomationpng","logoautomationpngnature","logoautomationpngcloseup","githubprofilepng","wildgithubprofilepng","githubprofilepngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

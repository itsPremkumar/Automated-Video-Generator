...
# 3) Run: bash broad_011_closeup_portrait_karaoke_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\broad_011_closeup_portrait_karaoke\render\_seg_broad_011_closeup_portrait_karaoke_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Broad closeup portrait karaoke","description":"Scene one from closeup view.

• Scene two continues.

#Shorts #AI #facts","tags":["perspcloseuppng","broadcloseupportrait","wildperspcloseuppng","perspcloseuppngnature","perspcloseuppngcloseup","persptoppng","wildpersptoppng","persptoppngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

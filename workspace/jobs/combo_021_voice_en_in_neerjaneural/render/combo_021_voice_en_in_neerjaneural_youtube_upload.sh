...
# 3) Run: bash combo_021_voice_en_in_neerjaneural_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_021_voice_en_in_neerjaneural\render\_seg_combo_021_voice_en_in_neerjaneural_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Voice en-IN-NeerjaNeural","description":"This is the english voice test.

• Speaking clearly for verification.

#Shorts #AI #facts","tags":["githubprofilepng","voiceneerjaneural","wildgithubprofilepng","githubprofilepngnature","githubprofilepngcloseup","logoautomationpng","wildlogoautomationpng","logoautomationpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

...
# 3) Run: bash combo_025_voice_fr_fr_deniseneural_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_025_voice_fr_fr_deniseneural\render\_seg_combo_025_voice_fr_fr_deniseneural_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Voice fr-FR-DeniseNeural","description":"This is the french voice test.

• Speaking clearly for verification.

#Shorts #AI #facts","tags":["githubprofilepng","voicedeniseneural","wildgithubprofilepng","githubprofilepngnature","githubprofilepngcloseup","logoautomationpng","wildlogoautomationpng","logoautomationpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

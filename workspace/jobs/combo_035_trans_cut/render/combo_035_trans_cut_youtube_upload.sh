...
# 3) Run: bash combo_035_trans_cut_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_035_trans_cut\render\_seg_combo_035_trans_cut_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Transition cut","description":"Transition test cut.

• Second transition.

#Shorts #AI #facts","tags":["logoautomationpng","transition","wildlogoautomationpng","logoautomationpngnature","logoautomationpngcloseup","githubprofilepng","wildgithubprofilepng","githubprofilepngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

...
# 3) Run: bash combo_019_voice_en_us_guyneural_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_019_voice_en_us_guyneural\render\_seg_combo_019_voice_en_us_guyneural_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Voice en-US-GuyNeural","description":"This is the english voice test.

• Speaking clearly for verification.

#Shorts #AI #facts","tags":["githubprofilepng","voiceguyneural","wildgithubprofilepng","githubprofilepngnature","githubprofilepngcloseup","logoautomationpng","wildlogoautomationpng","logoautomationpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

...
# 3) Run: bash combo_015_render_square_karaoke_nomus_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_015_render_square_karaoke_nomus\render\_seg_combo_015_render_square_karaoke_nomus_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Render square karaoke nomusic","description":"First scene of the test.

• Second scene continues.

#Shorts #AI #facts","tags":["githubprofilepng","rendersquarekaraoke","wildgithubprofilepng","githubprofilepngnature","githubprofilepngcloseup","logoautomationpng","wildlogoautomationpng","logoautomationpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

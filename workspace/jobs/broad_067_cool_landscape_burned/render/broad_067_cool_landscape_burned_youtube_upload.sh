...
# 3) Run: bash broad_067_cool_landscape_burned_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\broad_067_cool_landscape_burned\render\_seg_broad_067_cool_landscape_burned_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Broad cool landscape burned","description":"Scene one from cool view.

• Scene two continues.

#Shorts #AI #facts","tags":["perspcoolpng","broadcoollandscape","wildperspcoolpng","perspcoolpngnature","perspcoolpngcloseup","perspaerialpng","wildperspaerialpng","perspaerialpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

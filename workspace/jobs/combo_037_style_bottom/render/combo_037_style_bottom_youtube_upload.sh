...
# 3) Run: bash combo_037_style_bottom_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_037_style_bottom\render\_seg_combo_037_style_bottom_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Style bottom","description":"Style test bottom.

• Second style.

#Shorts #AI #facts","tags":["logoautomationpng","stylebottom","wildlogoautomationpng","logoautomationpngnature","logoautomationpngcloseup","githubprofilepng","wildgithubprofilepng","githubprofilepngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

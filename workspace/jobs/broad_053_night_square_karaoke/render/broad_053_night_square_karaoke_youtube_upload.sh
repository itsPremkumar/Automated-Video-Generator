...
# 3) Run: bash broad_053_night_square_karaoke_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\broad_053_night_square_karaoke\render\_seg_broad_053_night_square_karaoke_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Broad night square karaoke","description":"Scene one from night view.

• Scene two continues.

#Shorts #AI #facts","tags":["perspnightpng","broadnightsquare","wildperspnightpng","perspnightpngnature","perspnightpngcloseup","perspwarmpng","wildperspwarmpng","perspwarmpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

...
# 3) Run: bash broad_057_warm_portrait_none_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\broad_057_warm_portrait_none\render\_seg_broad_057_warm_portrait_none_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Broad warm portrait none","description":"Scene one from warm view.

• Scene two continues.

#Shorts #AI #facts","tags":["perspwarmpng","broadwarmportrait","wildperspwarmpng","perspwarmpngnature","perspwarmpngcloseup","perspaerialpng","wildperspaerialpng","perspaerialpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

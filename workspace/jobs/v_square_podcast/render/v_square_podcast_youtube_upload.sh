...
# 3) Run: bash v_square_podcast_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\v_square_podcast\render\_seg_v_square_podcast_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Square Podcast Variety","description":"Welcome to the show today.

• Let us dive into automation.

#Shorts #AI #facts","tags":["logoautomationpng","squarepodcastvariety","wildlogoautomationpng","logoautomationpngnature","logoautomationpngcloseup","githubprofilepng","wildgithubprofilepng","githubprofilepngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

...
# 3) Run: bash v_portrait_nomusic_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\v_portrait_nomusic\render\_seg_v_portrait_nomusic_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Portrait NoMusic Variety","description":"Here is a fast tip for you.

• Apply it daily for results.

#Shorts #AI #facts","tags":["githubprofilepng","portraitnomusicvariety","wildgithubprofilepng","githubprofilepngnature","githubprofilepngcloseup","logoautomationpng","wildlogoautomationpng","logoautomationpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

...
# 3) Run: bash combo_033_trans_slide_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_033_trans_slide\render\_seg_combo_033_trans_slide_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Transition slide","description":"Transition test slide.

• Second transition.

#Shorts #AI #facts","tags":["logoautomationpng","transitionslide","wildlogoautomationpng","logoautomationpngnature","logoautomationpngcloseup","githubprofilepng","wildgithubprofilepng","githubprofilepngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

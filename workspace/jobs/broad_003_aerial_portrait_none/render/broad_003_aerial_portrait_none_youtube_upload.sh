...
# 3) Run: bash broad_003_aerial_portrait_none_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\broad_003_aerial_portrait_none\render\_seg_broad_003_aerial_portrait_none_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Broad aerial portrait none","description":"Scene one from aerial view.

• Scene two continues.

#Shorts #AI #facts","tags":["perspaerialpng","broadaerialportrait","wildperspaerialpng","perspaerialpngnature","perspaerialpngcloseup","perspwarmpng","wildperspwarmpng","perspwarmpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

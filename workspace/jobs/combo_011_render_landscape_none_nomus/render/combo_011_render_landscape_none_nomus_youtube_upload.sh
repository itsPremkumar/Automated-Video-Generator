...
# 3) Run: bash combo_011_render_landscape_none_nomus_youtube_upload.sh
set -e
: "${YOUTUBE_ACCESS_TOKEN:?set YOUTUBE_ACCESS_TOKEN to your OAuth access token}"
VIDEO="C:\one\Automated-Video-Generator\workspace\jobs\combo_011_render_landscape_none_nomus\render\_seg_combo_011_render_landscape_none_nomus_0.mp4"
curl -s -X POST "https://www.googleapis.com/upload/youtube/v3/videos?part=snippet,status&uploadType=resumable" \
  ...
  -d '{"snippet":{"title":"Render landscape none nomusic","description":"First scene of the test.

• Second scene continues.

#Shorts #AI #facts","tags":["githubprofilepng","renderlandscapenone","wildgithubprofilepng","githubprofilepngnature","githubprofilepngcloseup","logoautomationpng","wildlogoautomationpng","logoautomationpngnature","ai","shorts","viral"]},"status":{"privacyStatus":"private"}}' \

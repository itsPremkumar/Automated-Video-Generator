...
export const IntroSceneCard: React.FC<{ card: IntroCard; accent: string; primary?: string }> = ({
    card,
    accent,
    primary = '#004E89',
}) => {
    ...
    return (
        <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center' }}>
            ...
            {/* decorative accent ring (spring-scaled) */}
            ...
            {card.subtitle && (
                <div style={{ opacity: subOpacity, color: '#fff', fontSize: 40, marginTop: 20, textAlign: 'center', padding: 20 }}>
                    {card.subtitle}
                </div>
            )}
        </AbsoluteFill>
...
export const OutroSceneCard: React.FC<{ card: OutroCard; accent: string; primary?: string }> = ({
    card,
    accent,
    primary = '#1A1A2E',
}) => {

...
export async function updateSceneInJob(
    ...
    // 1. REGENERATE AUDIO if text or voice settings changed
    ...
    // 2. REGENERATE VISUAL if keywords or local asset changed

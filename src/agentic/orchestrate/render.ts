...
import { runFinalGate, verifyRenderedVideo, PostRenderCheck } from '../gate.js';
...
import { writeJson, readJson } from '../workspace.js';
...
async function writeOutputArtifacts(
    ...
    try {
        const { archiveJob } = await import('../archive.js');
    ...
    try {
        const { openReview } = await import('../revision.js');

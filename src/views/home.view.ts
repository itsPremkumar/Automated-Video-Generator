...
function updateFieldStatus(id,saved){
    ...
    if(saved && input && !input.value){
        input.placeholder='Already saved (Enter new value to update)';
    }
}
